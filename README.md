...
- Dedicated Command Console Overview and Analysis layouts that retain the inherited parser,
  charts, tables, tree drill-down, copy, upload, and collapse behavior.
